...
$hx_exports["inflector"] = $hx_exports["inflector"] || {};
...
Test.__super__ = haxe_unit_TestCase;
Test.prototype = $extend(haxe_unit_TestCase.prototype,{
	test: function() {
		this.assertEquals(inflector_Inflections.pluralize("person"),"people",{ fileName : "Test.hx", lineNumber : 15, className : "Test", methodName : "test"});
		this.assertEquals(inflector_Inflections.pluralize("car"),"cars",{ fileName : "Test.hx", lineNumber : 16, className : "Test", methodName : "test"});
		this.assertEquals(inflector_Inflections.singularize("cars"),"car",{ fileName : "Test.hx", lineNumber : 17, className : "Test", methodName : "test"});
		this.assertEquals(inflector_Inflections.singularize("people"),"person",{ fileName : "Test.hx", lineNumber : 18, className : "Test", methodName : "test"});
	}
	,__class__: Test
});
...
var helpers__$AcceptEither_AcceptEither_$Impl_$ = {};
helpers__$AcceptEither_AcceptEither_$Impl_$.__name__ = ["helpers","_AcceptEither","AcceptEither_Impl_"];
helpers__$AcceptEither_AcceptEither_$Impl_$._new = function(e) {
	var this1 = e;
	return this1;
};
helpers__$AcceptEither_AcceptEither_$Impl_$.get_value = function(this1) {
	switch(this1[1]) {
	case 0:
		var v = this1[2];
		return v;
...
helpers__$AcceptEither_AcceptEither_$Impl_$.get_type = function(this1) {
	return this1;
};
helpers__$AcceptEither_AcceptEither_$Impl_$.fromA = function(v) {
	var this1 = helpers_Either.Left(v);
	return this1;
};
helpers__$AcceptEither_AcceptEither_$Impl_$.fromB = function(v) {
	var this1 = helpers_Either.Right(v);
	return this1;
};
var helpers_Either = { __ename__ : ["helpers","Either"], __constructs__ : ["Left","Right"] };
helpers_Either.Left = function(v) { var $x = ["Left",0,v]; $x.__enum__ = helpers_Either; return $x; };
helpers_Either.Right = function(v) { var $x = ["Right",1,v]; $x.__enum__ = helpers_Either; return $x; };
var inflector_FirstLetterCase = { __ename__ : ["inflector","FirstLetterCase"], __constructs__ : ["Upper","Lower"] };
inflector_FirstLetterCase.Upper = ["Upper",0];
inflector_FirstLetterCase.Upper.__enum__ = inflector_FirstLetterCase;
inflector_FirstLetterCase.Lower = ["Lower",1];
inflector_FirstLetterCase.Lower.__enum__ = inflector_FirstLetterCase;
var inflector_Inflections = $hx_exports["inflector"]["Inflections"] = function() {
	this.acronym_regex = new EReg("(?=a)b","");
	this.acronyms = new haxe_ds_StringMap();
	this.humans = [];
	this.uncountables = [];
	this.singulars = [];
	this.plurals = [];
};
inflector_Inflections.__name__ = ["inflector","Inflections"];
inflector_Inflections.instance = function(locale) {
	if(locale == null) {
		locale = "en";
	}
	var _this = inflector_Inflections._instance;
	if(!(__map_reserved[locale] != null ? _this.existsReserved(locale) : _this.h.hasOwnProperty(locale))) {
		var inflect = new inflector_Inflections();
		inflector_Inflections.populate_default_inflections(inflect);
		var _this1 = inflector_Inflections._instance;
		if(__map_reserved[locale] != null) {
			_this1.setReserved(locale,inflect);
		} else {
			_this1.h[locale] = inflect;
		}
	}
	var _this2 = inflector_Inflections._instance;
	if(__map_reserved[locale] != null) {
		return _this2.getReserved(locale);
	} else {
		return _this2.h[locale];
	}
};
inflector_Inflections.inflections = function(locale,block) {
	if(locale == null) {
		locale = "en";
	}
	if(block != null) {
		block(inflector_Inflections.instance("en"));
	}
	return inflector_Inflections.instance();
};
inflector_Inflections.populate_default_inflections = function(inflect) {
	...
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("s$","i")),"");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(ss)$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(n)ews$","i")),"$1ews");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("([ti])a$","i")),"$1um");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)(sis|ses)$","i")),"$1sis");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(^analy)(sis|ses)$","i")),"$1sis");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("([^f])ves$","i")),"$1fe");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(hive)s$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(tive)s$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("([lr])ves$","i")),"$1f");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("([^aeiouy]|qu)ies$","i")),"$1y");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(s)eries$","i")),"$1eries");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(m)ovies$","i")),"$1ovie");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(x|ch|ss|sh)es$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("^(m|l)ice$","i")),"$1ouse");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(bus)(es)?$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(o)es$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(shoe)s$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(cris|test)(is|es)$","i")),"$1is");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("^(a)x[ie]s$","i")),"$1xis");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(octop|vir)(us|i)$","i")),"$1us");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(alias|status)(es)?$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("^(ox)en","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(vert|ind)ices$","i")),"$1ex");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(matr)ices$","i")),"$1ix");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(quiz)zes$","i")),"$1");
	inflect.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(database)s$","i")),"$1");
...
inflector_Inflections.pluralize = function(word,locale) {
	if(locale == null) {
		locale = "en";
	}
	return inflector_Inflections.apply_inflections(word,inflector_Inflections.inflections(locale).plurals);
};
inflector_Inflections.singularize = function(word,locale) {
	if(locale == null) {
		locale = "en";
	}
	return inflector_Inflections.apply_inflections(word,inflector_Inflections.inflections(locale).singulars);
};
inflector_Inflections.camelize = function(term,uppercase_first_letter) {
	...
	if(uppercase_first_letter) {
		term = new EReg("^[a-z\\d]*","i").map(term,function(r) {
			...
			var _this = inflector_Inflections.inflections().acronyms;
			if(__map_reserved[match] != null ? _this.existsReserved(match) : _this.h.hasOwnProperty(match)) {
				var _this1 = inflector_Inflections.inflections().acronyms;
				if(__map_reserved[match] != null) {
					return _this1.getReserved(match);
				} else {
					return _this1.h[match];
				}
			} else {
				return HxOverrides.substr(match,0,1).toUpperCase() + HxOverrides.substr(match,1,match.length - 1);
			}
		});
	} else {
		term = new EReg("^(?:{inflections().acronym_regex}(?=\\b|[A-Z_])|\\w","i").matched(0);
	}
	term = new EReg("(?:_|(\\/))([a-z\\d]*)","i").map(term,function(r1) {
		var group_1 = r1.matched(1);
		var group_2 = r1.matched(2);
		var secondPart;
		var _this2 = inflector_Inflections.inflections().acronyms;
		if(__map_reserved[group_2] != null ? _this2.existsReserved(group_2) : _this2.h.hasOwnProperty(group_2)) {
			var _this3 = inflector_Inflections.inflections().acronyms;
			if(__map_reserved[group_2] != null) {
				secondPart = _this3.getReserved(group_2);
			} else {
				secondPart = _this3.h[group_2];
			}
		} else {
			secondPart = HxOverrides.substr(group_2,0,1).toUpperCase() + HxOverrides.substr(group_2,1,group_2.length - 1);
		}
...
inflector_Inflections.underscore = function(camel_cased_word) {
	if(!new EReg("[A-Z-]|::","").match(camel_cased_word)) {
		return camel_cased_word;
	}
	var word = StringTools.replace(camel_cased_word,"::","/");
	...
	var _this_r = new RegExp("([A-Z\\d]+)([A-Z][a-z]","i".split("u").join(""));
	word = word.replace(_this_r,"$1_$2");
	var _this_r1 = new RegExp("([a-z\\d])([A-Z])","i".split("u").join(""));
	word = word.replace(_this_r1,"$1_$2");
	word = StringTools.replace(word,"-","_");
	word = word.toLowerCase();
	return word;
};
inflector_Inflections.substitute = function(result,rules) {
	var _g = 0;
	while(_g < rules.length) {
		var rule = rules[_g];
		++_g;
		if(rule.RuleRegex.match(result)) {
			result = result.replace(rule.RuleRegex.r,rule.Replacement);
			break;
		}
	}
	return result;
};
inflector_Inflections.humanize = function(lower_case_and_underscored_word,capitalize) {
	if(capitalize == null) {
		capitalize = true;
	}
	var result = lower_case_and_underscored_word;
	result = inflector_Inflections.substitute(result,inflector_Inflections.inflections().humans);
	var _this_r = new RegExp("\\A_+","i".split("u").join(""));
	result = result.replace(_this_r,"");
	var _this_r1 = new RegExp("_id\\z","i".split("u").join(""));
	result = result.replace(_this_r1,"");
	...
	if(capitalize) {
		result = new EReg("\\A\\w","i").map(result,function(r1) {
			var match1 = r1.matched(0);
			return match1.toUpperCase();
		});
	}
	return result;
};
inflector_Inflections.titleize = function(word) {
	return new EReg("\\b(?<!['’`])[a-z]","i").map(inflector_Inflections.humanize(inflector_Inflections.underscore(word)),function(r) {
		var s = r.matched(0);
		return HxOverrides.substr(s,0,1).toUpperCase() + HxOverrides.substr(s,1,s.length - 1);
	});
};
inflector_Inflections.tableize = function(class_name) {
	return inflector_Inflections.pluralize(inflector_Inflections.underscore(class_name));
};
inflector_Inflections.classify = function(table_name) {
	var _this_r = new RegExp(".*\\.","i".split("u").join(""));
	return inflector_Inflections.camelize(inflector_Inflections.singularize(table_name.replace(_this_r,"")));
};
inflector_Inflections.dasherize = function(underscored_word) {
	return StringTools.replace(underscored_word,"_","-");
};
inflector_Inflections.demodulize = function(path) {
	var ind = path.lastIndexOf("::");
	if(ind >= 0) {
		return path.substring(ind + 2);
	} else {
		return path;
	}
};
inflector_Inflections.deconstantize = function(path) {
	var ind = path.lastIndexOf("::");
	return path.substring(0,ind >= 0 ? ind : 0);
};
inflector_Inflections.foreign_key = function(class_name,separate_class_name_and_id_with_underscore) {
	if(separate_class_name_and_id_with_underscore == null) {
		separate_class_name_and_id_with_underscore = true;
	}
	return inflector_Inflections.underscore(inflector_Inflections.demodulize(class_name)) + (separate_class_name_and_id_with_underscore ? "_id" : "id");
};
inflector_Inflections.constantize = function(camel_cased_word) {
};
inflector_Inflections.safe_constantize = function(camel_cased_word) {
};
inflector_Inflections.ordinal = function(numberStr) {
	var number = Std.parseInt(numberStr);
	var abs_number = Math.abs(number);
	if(abs_number % 100 >= 11 && abs_number % 100 <= 13) {
		return "th";
	}
	var _g = abs_number % 10;
	switch(_g) {
	case 1:
		return "st";
	case 2:
...
inflector_Inflections.ordinalize = function(data) {
	var _g = data;
	switch(_g[1]) {
	case 0:
		var str = _g[2];
...
inflector_Inflections.eregReplace = function(str) {
	return StringTools.replace(str,"[-\\/\\^$*+?.()|[\\]{}]/g","\\$&");
};
inflector_Inflections.parameterize = function(str,sep) {
	if(sep == null) {
		sep = "\\-";
	}
	var parameterized_string = inflector_Inflections.transliterate(str);
	var _this_r = new RegExp("[^a-z0-9\\-_]+","i".split("u").join(""));
	parameterized_string = parameterized_string.replace(_this_r,sep);
	if(sep != null) {
		var re_sep = new EReg(inflector_Inflections.eregReplace(sep),"i");
		var _this_r1 = new RegExp(Std.string(re_sep) + "{2,}","i".split("u").join(""));
		parameterized_string = parameterized_string.replace(_this_r1,sep);
		var _this_r2 = new RegExp("^{re_sep}|{re_sep}$","i".split("u").join(""));
		parameterized_string = parameterized_string.replace(_this_r2,"");
	}
	return parameterized_string.toLowerCase();
};
inflector_Inflections.apply_inflections = function(word,rules) {
	var result = word;
	if(word == null || word == "" || thx_Arrays.contains(inflector_Inflections.inflections().uncountables,result.toLowerCase())) {
		return result;
	}
	return inflector_Inflections.substitute(result,rules);
};
inflector_Inflections.transliterate = function(str,replacement) {
	if(replacement == null) {
		replacement = "?";
	}
	return "";
};
inflector_Inflections.prototype = {
	plurals: null
	,singulars: null
	,uncountables: null
	,humans: null
	...
	,acronym: function(word) {
		var this1 = this.acronyms;
		var k = word.toLowerCase();
		var _this = this1;
		if(__map_reserved[k] != null) {
			_this.setReserved(k,word);
		} else {
			_this.h[k] = word;
		}
		this.acronym_regex = new EReg(Lambda.array(this.acronyms).join("|"),"i");
	}
	,plural: function(rule,replacement) {
		HxOverrides.remove(this.uncountables,replacement);
		this.plurals.splice(0,0,{ RuleRegex : rule, Replacement : replacement});
	}
	,singular: function(rule,replacement) {
		...
		case 0:
			var str = _g[2];
			this.singulars.splice(0,0,{ RuleString : str, Replacement : replacement});
			HxOverrides.remove(this.uncountables,str);
			break;
		case 1:
			var regex = _g[2];
			this.singulars.splice(0,0,{ RuleRegex : regex, Replacement : replacement});
			break;
		}
		HxOverrides.remove(this.uncountables,replacement);
	}
	,irregular: function(singular_str,plural_str) {
		HxOverrides.remove(this.uncountables,singular_str);
		HxOverrides.remove(this.uncountables,plural_str);
		var s0 = HxOverrides.substr(singular_str,0,1);
		var srest = HxOverrides.substr(singular_str,1,null);
		var p0 = HxOverrides.substr(plural_str,0,1);
		var prest = HxOverrides.substr(plural_str,1,null);
		if(s0.toUpperCase() == p0.toUpperCase()) {
			this.plural(new EReg("(" + s0 + ")" + srest + "$","i"),"$1" + prest);
			this.plural(new EReg("(" + p0 + ")" + prest + "$","i"),"$1" + prest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(" + s0 + ")" + srest + "$","i")),"$1" + srest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("(" + p0 + ")" + prest + "$","i")),"$1" + srest);
		} else {
			this.plural(new EReg("" + s0.toUpperCase() + "(?i)" + srest + "$","i"),p0.toUpperCase() + prest);
			this.plural(new EReg("" + s0.toLowerCase() + "(?i)" + srest + "$","i"),p0.toLowerCase() + prest);
			this.plural(new EReg("" + p0.toUpperCase() + "(?i)" + prest + "$","i"),p0.toUpperCase() + prest);
			this.plural(new EReg("" + p0.toLowerCase() + "(?i)" + prest + "$","i"),p0.toLowerCase() + prest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("" + s0.toUpperCase() + "(?i)" + srest + "$","i")),s0.toUpperCase() + srest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("" + s0.toLowerCase() + "(?i)" + srest + "$","i")),s0.toLowerCase() + srest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("" + p0.toUpperCase() + "(?i)" + prest + "$","i")),s0.toUpperCase() + srest);
			this.singular(helpers__$AcceptEither_AcceptEither_$Impl_$.fromB(new EReg("" + p0.toLowerCase() + "(?i)" + prest + "$","i")),s0.toLowerCase() + srest);
		}
	}
	,uncountable: function(words) {
		this.uncountables.concat(words.map(function(el) {
			return el.toLowerCase();
		}));
	}
	,human: function(rule,replacement) {
		var _this = this.humans;
		var x = { RuleRegex : new EReg(rule,"i"), Replacement : replacement};
		_this.splice(0,0,x);
	}
	...
	,__class__: inflector_Inflections
};
...
inflector_Inflections._instance = new haxe_ds_StringMap();
